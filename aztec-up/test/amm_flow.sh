...
aztec-wallet \
  ...
  -aw authwits:amm-add-liquidity-token_0,authwits:amm-add-liquidity-token_1 \
  -f accounts:main \
  $SPONSORED_FPC_PAYMENT_METHOD
...
#   create-authwit transfer_to_public contracts:amm \
#   -ca contracts:token_liquidity \
#   --args $current_user_address contracts:amm $liquidity_token_balance secrets:burn-nonce \
